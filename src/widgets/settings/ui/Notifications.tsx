		...
		<Card className="space-y-8 bg-background text-card-foreground border border-gray-700 shadow-xl">
			...
			<form onSubmit={handleSubmit} className="space-y-8">
				...
				<div className="space-y-6">
					<h3 className="text-lg font-semibold text-card-foreground border-b border-gray-700 pb-2">Каналы уведомлений</h3>
				...
				<div className="space-y-6">
					<h3 className="text-lg font-semibold text-card-foreground border-b border-gray-700 pb-2">Категории уведомлений</h3>
				...
				{/* Frequency Settings */}
				<div className="space-y-6">
					<h3 className="text-lg font-semibold text-card-foreground border-b border-gray-700 pb-2">Частота уведомлений</h3>
				...
				<div className="flex justify-end pt-6 border-t border-gray-700">
					<Button type="submit" disabled={isLoading} className="bg-blue-600 hover:bg-blue-700 text-card-foreground px-8 py-2">
