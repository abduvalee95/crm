...
import { ViewMode, DealStage } from "@/lib/enums/deal";
      ...
      <Card className="bg-[#1B1E23] border-gray-800 text-white">
        ...
        <CardContent>
          {filteredDeals.map(deal => (
            <div key={deal.id} className="grid grid-cols-6 items-center gap-4 p-4 border-b border-gray-800 last:border-b-0 hover:bg-gray-800/20">
